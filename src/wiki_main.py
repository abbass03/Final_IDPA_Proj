...
def main() -> None:
    ...
    result = compare_documents("wiki", file1, file2, method=method)
    ...
    print("Saved Tree 1 infobox:", result["output_paths"]["tree1_infobox"])
    print("Saved Tree 2 infobox:", result["output_paths"]["tree2_infobox"])
    print("Saved patched infobox:", result["output_paths"]["patched_infobox"])
